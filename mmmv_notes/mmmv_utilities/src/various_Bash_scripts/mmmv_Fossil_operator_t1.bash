...
if [ "$S_TMP_0" == "" ]; then
    ...
    echo "  GUID=='39a0edb3-fbbc-4972-9845-618251c120e7'"
    echo ""
                    ...
                    if [ "$2" != "" ]; then
                        if [ "$2" == "use_autogenerated_commit_message" ]; then
                            if [ "$3" != "" ]; then
                                ...
                                echo "GUID=='1632813d-d2db-4db8-8589-73f070d120e7'"
                                S_ACTIVITY_OF_THIS_SCRIPT="help"
                                SB_EXIT_WITH_ERROR="t"
                            fi
                        else
                            if [ "$2" == "read_commit_message_from_file" ]; then
                                ...
                                if [ "$S_FP_MESSAGE_FILE_CANDIDATE" == "" ]; then
                                    ...
                                    echo "GUID=='5ead5372-912f-465c-9629-21f070d120e7'"
                                    S_ACTIVITY_OF_THIS_SCRIPT="help"
                                    SB_EXIT_WITH_ERROR="t"
                                fi
                                if [ "$SB_EXIT_WITH_ERROR" == "f" ]; then
                                    if [ "$4" != "" ]; then
                                        ...
                                        echo "$4"
                                        echo "---citation--end-----"
                                        echo "GUID=='d2e6865f-faec-41bf-85d5-7282b0d120e7'"
                                        S_ACTIVITY_OF_THIS_SCRIPT="help"
                                        SB_EXIT_WITH_ERROR="t"
                                    fi
                                fi
                                if [ "$SB_EXIT_WITH_ERROR" == "f" ]; then
                                    if [ ! -e "$S_FP_MESSAGE_FILE_CANDIDATE" ]; then 
                                        ...
                                        echo "GUID=='b5b96d27-6a24-4140-b422-22f001d120e7'"
                                        S_ACTIVITY_OF_THIS_SCRIPT="help"
                                        SB_EXIT_WITH_ERROR="t"
                                    fi
                                fi 
                                if [ "$SB_EXIT_WITH_ERROR" == "f" ]; then
                                    if [ -d "$S_FP_MESSAGE_FILE_CANDIDATE" ]; then 
                                        ...
                                        echo "GUID=='42f7a3d4-b9ca-4cb2-8550-626101d120e7'"
                                        S_ACTIVITY_OF_THIS_SCRIPT="help"
                                        SB_EXIT_WITH_ERROR="t"
                                    fi
                                fi
                                if [ "$SB_EXIT_WITH_ERROR" == "f" ]; then
                                    ...
                                    if [ "$S_TMP_1" == "too_big" ]; then
                                        ...
                                        echo "GUID=='989d6e39-79fb-4d09-9591-d24011d120e7'"
                                        S_ACTIVITY_OF_THIS_SCRIPT="help"
                                        SB_EXIT_WITH_ERROR="t"
                                    else
                                        if [ "$S_TMP_0" == "0" ]; then
                                            ...
                                            echo "    \"read_commit_message_from_file\" ."
                                            echo ""
                                            echo "GUID=='515e277f-1438-48a3-8023-b14011d120e7'"
                                            S_ACTIVITY_OF_THIS_SCRIPT="help"
                                            SB_EXIT_WITH_ERROR="t"
                                        fi
                                    fi
                                ...
                                if [ "$SB_EXIT_WITH_ERROR" == "f" ]; then
                                    ...
                                    if [ "$S_TMP_0" == "" ]; then
                                        ...
                                        echo "GUID=='14775a13-45e3-4b64-b7d8-d26301d120e7'"
                                        S_ACTIVITY_OF_THIS_SCRIPT="help"
                                        SB_EXIT_WITH_ERROR="t"
                                    fi
                                fi 
                    ...
                    if [ "$S_ACTIVITY_OF_THIS_SCRIPT" == "shred_local_copy" ]; then
                        if [ "$2" != "" ]; then # the 2. arg is optional here
                            if [ "$2" != "$S_ARGNAME_ACTIVITY_SHRED_ARG_2" ]; then 
                                ...
                                echo "GUID=='1712af32-1973-4966-b207-a2e070d120e7'"
                                S_ACTIVITY_OF_THIS_SCRIPT="help"
                                SB_EXIT_WITH_ERROR="t"
                            fi
                        fi
                        ...
                        if [ "$S_ACTIVITY_OF_THIS_SCRIPT" != "print_script_version" ]; then
                            if [ "$S_ACTIVITY_OF_THIS_SCRIPT" != "help" ]; then
                                ...
                                echo "GUID=='e216e828-a4d4-48c8-912e-c0e070d120e7'"
                                S_ACTIVITY_OF_THIS_SCRIPT="help"
                                SB_EXIT_WITH_ERROR="t"
                            fi
                        fi
...
# GUID regex. :-D 
S_VERSION_OF_THIS_SCRIPT="3be25a83-6e1d-4699-a133-e1d1c0c120e7"
if [ "$S_ACTIVITY_OF_THIS_SCRIPT" == "print_script_version" ]; then
...
fun_assertion_t1() {
    ...
    if [ "$SB_THROW" == "t" ]; then
        ...
        echo "GUID=='634da559-8e10-4462-a3f8-92d041a120e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1
...
fun_assert_repository_local_copy_existence() {
    if [ "$SB_FOSSILFILE_EXISTS" == "f" ]; then
        ...
        echo "GUID=='fa772839-11bb-41ee-928e-c15171a120e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1
    ...
    if [ "$SB_SANDBOX_DIR_EXISTS" == "f" ]; then
        ...
        echo ""
        echo "Aborting script."
        echo "GUID=='37d35fe0-1c91-414f-89ec-73a171a120e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1
...
fun_assert_the_lack_of_repository_local_copy_t1() {
    if [ "$SB_FOSSILFILE_EXISTS" == "t" ]; then
        ...
        echo "GUID=='b542343e-9b38-4806-920a-c09200b120e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1
    ...
    if [ "$SB_SANDBOX_DIR_EXISTS" == "t" ]; then
        ...
        echo "To avoid overwriting an existing local copy, this script is aborted"
        echo "and nothing is downloaded/uploaded by this script."
        echo "GUID=='f7067529-27b7-4bca-92b6-539200b120e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1
...
fun_last_minute_checks_t1() {
    ...
    if [ "$S_FP_FORBIDDEN_VALUE" == "/" ]; then
        echo ""
        echo "This Bash script is flawed."
        echo "GUID=='d1126c9d-15c7-4914-b985-408350b120e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1
    ...
    if [ "$S_FP_FORBIDDEN_VALUE" == "$HOME" ]; then
        echo ""
        echo "This Bash script is flawed."
        echo "GUID=='26ff4016-2448-468c-a3c8-109350b120e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1
    ...
    if [ "$S_FP_FORBIDDEN_VALUE" == "/home" ]; then
        echo ""
        echo "This Bash script is flawed."
        echo "GUID=='14eb6b1c-ddb7-447b-b5a2-73c160b120e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1
    ...
    if [ "$S_FP_FORBIDDEN_VALUE" == "/root" ]; then
        echo ""
        echo "This Bash script is flawed."
        echo "GUID=='54b44882-3201-4296-a2a2-73c160b120e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1
    ...
    if [ "$S_FP_FORBIDDEN_VALUE" == "/etc" ]; then
        echo ""
        echo "This Bash script is flawed."
        echo "GUID=='7562a5f9-e078-415a-84a2-73c160b120e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1
    ...
    if [ "$S_FP_FORBIDDEN_VALUE" == "/usr" ]; then
        echo ""
        echo "This Bash script is flawed."
        echo "GUID=='223bd54e-b963-4419-94a2-73c160b120e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1
...
if [ "$SB_FOLDER_IS_EMPTY" == "t" ]; then
    ...
    echo "GUID=='11e8bf2b-ff24-4c0a-adc9-507090b120e7'"
    echo ""
    #----
    cd $S_FP_ORIG
    exit 1
    ...
    cd $S_FP_SANDBOX
        ...
        if [ "$SB_FOLDER_IS_EMPTY" == "f" ]; then
            ...
            if [ "$S_FP_SANDBOX" == "`pwd`" ]; then
                ...
                echo ""
                echo "This Bash script is flawed."
                echo "GUID=='36694712-c5d6-4c26-b9c8-826171c120e7'"
                echo ""
                #----
                cd $S_FP_ORIG
                exit 1
        ...
        if [ "$SB_FOLDER_IS_EMPTY" == "f" ]; then
            if [ "$S_FP_SANDBOX" != "`pwd`" ]; then
                echo ""
                echo "This Bash script is flawed."
                echo "GUID=='7d4eb053-269b-48ac-9259-d29171c120e7'"
                echo ""
                #----
                cd $S_FP_ORIG
                exit 1
                ...
                if [ "$2" == "use_autogenerated_commit_message" ]; then
                    ...
                    if [ "$2" == "read_commit_message_from_file" ]; then
                        ...
                        if [ -d "$S_FP_MESSAGE_FILE_CANDIDATE" ]; then 
                            ...
                            echo "GUID=='5242ce30-9b0d-4460-9c32-523311d120e7'"
                            echo ""
                            #----
                            cd $S_FP_ORIG
                            exit 1
...
echo ""
echo "This Bash script is flawed."
echo "GUID=='53fceada-cfba-4387-8ce3-03d141a120e7'"
echo ""
#----
cd $S_FP_ORIG
exit 1
