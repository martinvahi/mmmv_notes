...
func_mmmv_bash_boilerplate_version(){
    local S_GUID="13cd7314-a42b-4bb1-92a1-8360902038e7"
...
func_mmmv_init_s_timestamp_if_not_inited_t1(){
    if [ "$S_TIMESTAMP" == "" ]; then
        if [ "`which date 2> /dev/null`" != "" ]; then
            ...
            echo ""
            echo "GUID=='53772635-87d4-4245-b2a1-8360902038e7'"
            echo ""
        fi
    fi
} # func_mmmv_init_s_timestamp_if_not_inited_t1
...
func_mmmv_verify_S_FP_ORIG_but_do_not_exit_t1(){
    ...
    if [ "$S_FP_ORIG" == "" ]; then 
        ...
        echo "GUID=='98cabd13-3821-4a10-a3a1-8360902038e7'"
        echo ""
    else
        if [ ! -e "$S_FP_ORIG" ]; then 
            SB_S_FP_ORIG_VERIFICATION_FAILED="t"
            ...
            echo ""
            echo "GUID=='9188692d-b2a5-4878-b591-8360902038e7'"
            echo ""
        else
            if [ ! -d "$S_FP_ORIG" ]; then 
                SB_S_FP_ORIG_VERIFICATION_FAILED="t"
                ...
                echo "    S_FP_ORIG==$S_FP_ORIG"
                echo ""
                echo "GUID=='11665ec4-bb72-457f-ab91-8360902038e7'"
                echo ""
            fi
        fi
    fi
    ...
    #        echo "GUID=='74a26e50-e9b1-409f-9381-8360902038e7'"
    #        echo ""
    #    fi
} # func_mmmv_verify_S_FP_ORIG_but_do_not_exit_t1
...
func_mmmv_verify_S_FP_ORIG_but_do_not_exit_t2(){
    if [ "$SB_FUNC_MMMV_VERIFY_S_FP_ORIG_BUT_DO_NOT_EXIT_T2_S_FB_ORIG_ALREADY_VERIFIED" != "t" ]; then
        if [ "$SB_FUNC_MMMV_VERIFY_S_FP_ORIG_BUT_DO_NOT_EXIT_T2_S_FB_ORIG_ALREADY_VERIFIED" != "f" ]; then
            ...
            echo "GUID=='ff2aa317-f445-489e-9481-8360902038e7'"
            echo ""
        else
            func_mmmv_verify_S_FP_ORIG_but_do_not_exit_t1
...
func_mmmv_assert_nonempty_string_but_do_not_exit_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then 
        ...
        echo "GUID=='47f27a26-6ba9-41d1-9361-8360902038e7'"
        echo ""
    ...
    if [ "$SB_NO_ERRORS_YET" != "t" ]; then 
        ...
        if [ "$SB_NO_ERRORS_YET" == "f" ]; then 
            ...
            echo "GUID=='300bc35d-98ca-4394-9351-8360902038e7'"
        else
            echo "is expected to be initialized to \"t\" before calling this function"
            echo "and its domain is {\"f\", \"t\"}."
            echo "GUID=='2030cd5d-f58f-4864-a351-8360902038e7'"
        fi
    ...
    if [ "$SB_NO_ERRORS_YET" == "t" ]; then 
        if [ "$S_VARIABLE_NAME_IN_CALLING_CODE" == "" ]; then 
            ...
            echo ""
            echo "GUID=='b380692f-d992-4270-9141-8360902038e7'"
    ...
    if [ "$SB_NO_ERRORS_YET" == "t" ]; then 
        if [ "$S_IN" == "" ]; then 
            ...
            echo "GUID=='4230c026-8522-493b-9541-8360902038e7'"
            if [ "$SB_NO_ERRORS_YET_1" == "t" ]; then  # should be always true at this line
                echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
            fi
            echo ""
...
func_mmmv_assert_sbvar_domain_t_f_but_do_not_exit_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then 
        ...
        echo ""
        echo "but it is expected to be a GUID."
        echo "GUID=='df43bd25-fa98-4719-a341-8360902038e7'"
        echo ""
        SB_NO_ERRORS_YET_1="f"
    fi
    #--------------------
    if [ "$SB_NO_ERRORS_YET" != "t" ]; then 
        ...
        if [ "$SB_NO_ERRORS_YET" == "f" ]; then 
            echo "is expected to be initialized to \"t\" before calling this function."
            echo "GUID=='83e16c5c-8b5e-4f38-b131-8360902038e7'"
        else
            echo "is expected to be initialized to \"t\" before calling this function"
            echo "and its domain is {\"f\", \"t\"}."
            echo "GUID=='5e19fb75-e69f-4987-9531-8360902038e7'"
        fi
        if [ "$SB_NO_ERRORS_YET_1" == "t" ]; then 
            echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        fi
    ...
    if [ "$SB_NO_ERRORS_YET" == "t" ]; then 
        if [ "$S_VARIABLE_NAME_IN_CALLING_CODE" == "" ]; then 
            ...
            echo "    S_VARIABLE_NAME_IN_CALLING_CODE==\"\""
            echo ""
            echo "GUID=='964c7537-a895-4fcb-8321-8360902038e7'"
            if [ "$SB_NO_ERRORS_YET_1" == "t" ]; then  # should be always true at this line
                echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
            fi
            echo ""
    ...
    if [ "$SB_NO_ERRORS_YET" == "t" ]; then 
        if [ "$SB_VARIABLE_VALUE" != "t" ]; then 
            if [ "$SB_VARIABLE_VALUE" != "f" ]; then 
                ...
                echo "GUID=='11e6c074-d3ba-4f1b-a721-8360902038e7'"
                if [ "$SB_NO_ERRORS_YET_1" == "t" ]; then  # should be always true at this line
                    echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
                fi
                echo ""
...
func_mmmv_report_an_error_but_do_not_exit_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then 
        ...
        echo "GUID=='2e1f351a-a076-40c3-b211-8360902038e7'"
        echo ""
    else
        echo ""
        echo -e "\e[31mThe code of this script is flawed.\e[39m"
        ...
        echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo "GUID=='05598f1b-b47e-439a-b311-8360902038e7'"
        echo ""
    fi
    #----------------------------------------------------------------------
    # exit 1 # must NOT be called in ~/.bashrc, because 
...
func_mmmv_report_missing_from_path_and_do_NOT_exit_t1() {
    ...
    if [ "$S_TMP_1" == "" ] ; then
        ...
        echo "GUID=='04955256-9eae-4ab5-8511-8360902038e7'"
        echo ""
    fi
    #----------------------------------------------------------------------
    # exit 1 # must NOT be called in ~/.bashrc, because 
...
func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1() {  # S_FP, S_GUID_CANDIDATE
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "GUID=='64168413-2e17-4677-8101-8360902038e7'"
        echo ""
        #--------
        ...
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" != "" ]; then
            if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" == "f" ]; then
                ...
                if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" != "t" ]; then
                    ...
                    echo "\"\" defaults to \"t\"."
                    echo "GUID=='4b9451a5-b5ab-4e02-9201-8360902038e7'"
                    echo ""
                    #--------
                    SB_VERIFICATION_FAILED="t"
                fi
        ...
        if [ ! -e "$S_FP" ]; then
            if [ -h "$S_FP" ]; then
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo "GUID=='19574d4f-d893-458b-81f0-8360902038e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
                ...
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo "GUID==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='4f264ba4-ca81-4550-aef0-8360902038e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
            ...
            if [ -d "$S_FP" ]; then
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo "GUID==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='588eb854-4360-47bb-b5f0-8360902038e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
    ...
    if [ "$SB_VERIFICATION_FAILED" != "t" ]; then
        if [ "$SB_VERIFICATION_FAILED" != "f" ]; then
            ...
            echo "GUID=='88c0a22c-ba18-4905-94e0-8360902038e7'"
            echo ""
        fi
    fi
    #------------------------------
...
func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1() {  # S_FP, S_GUID_CANDIDATE
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "This function requires 2 parameters: S_FP, S_GUID_CANDIDATE"
        echo "and has an optional 3. parameter: SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE"
        echo "GUID=='0eadb74b-2d4c-42ad-a1e0-8360902038e7'"
        echo ""
        #--------
        SB_VERIFICATION_FAILED="t"
    fi
        ...
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" != "" ]; then
            if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" == "f" ]; then
                ...
                if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" != "t" ]; then
                    ...
                    echo "Valid values are: \"t\", \"f\", \"\" ."
                    echo "\"\" defaults to \"t\"."
                    echo "GUID=='9b428e3e-dd51-4f8e-84e0-8360902038e7'"
                    echo ""
                    #--------
                    SB_VERIFICATION_FAILED="t"
                fi
        ...
        if [ ! -e "$S_FP" ]; then
            if [ -h "$S_FP" ]; then
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo "GUID==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='f1bc9d5b-92dc-4d18-b1d0-8360902038e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
                ...
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo -e "\e[31mdoes not exist\e[39m."
                    echo "GUID==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='2ae4a24c-bf16-4d2c-84d0-8360902038e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
            ...
            if [ ! -d "$S_FP" ]; then
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo "GUID==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='2227b341-387c-42b6-8ac0-8360902038e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
    ...
    if [ "$SB_VERIFICATION_FAILED" != "t" ]; then
        if [ "$SB_VERIFICATION_FAILED" != "f" ]; then
            echo ""
            echo -e "\e[31mThe code of this Bash function is flawed.\e[39m"
            echo "GUID=='d54a4d92-75da-4989-b1c0-8360902038e7'"
            echo ""
        fi
    fi
    #------------------------------
...
func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1(){
    ...
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
        if [ "$S_GUID_CANDIDATE" == "" ]; then
            ...
            echo "    S_GUID_CANDIDATE==\"\""
            echo ""
            echo "GUID=='d05dcd34-ccd0-4e60-93b0-8360902038e7'"
            echo ""
            #--------
            SB_VERIFICATION_FAILED="t"
        fi
    ...
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
        if [ "$S_FP_INSTALLATION_FOLDER" == "" ]; then
            ...
            echo "GUID=='d619ba21-8966-4976-93b0-8360902038e7'"
            echo ""
            #--------
            SB_VERIFICATION_FAILED="t"
        fi
        ...
        if [ "$SB_MAN_FOLDER_EXISTENCE_IS_MANDATORY" == "" ]; then
            ...
            if [ "$SB_MAN_FOLDER_EXISTENCE_IS_MANDATORY" != "t" ]; then
                if [ "$SB_MAN_FOLDER_EXISTENCE_IS_MANDATORY" != "f" ]; then
                    ...
                    echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
                    echo "GUID=='29e91a35-467d-45ab-b3b0-8360902038e7'"
                    echo ""
                    #--------
                    SB_VERIFICATION_FAILED="t"
                fi
    ...
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
        func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
            "$S_FP_INSTALLATION_FOLDER" "4eb76681-966a-4add-b191-8360902038e7"
        if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
            #--------------
            func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
                "$S_FP_INSTALLATION_FOLDER/bin" "24ee5cdd-56d9-419c-a391-8360902038e7"
            if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
            ...
            if [ "$SB_MAN_FOLDER_OR_NONBROKEN_SYMLINK_TO_IT_EXISTS" == "f" ]; then
                if [ "$SB_MAN_FOLDER_EXISTENCE_IS_MANDATORY" == "t" ]; then
                    ...
                    func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
                        "$S_FP_INSTALLATION_FOLDER/share/man" "28691f03-ce9f-423d-9991-8360902038e7"
                fi
            else
    ...
    if [ "$SB_VERIFICATION_FAILED" != "t" ]; then
        if [ "$SB_VERIFICATION_FAILED" != "f" ]; then
            echo ""
            echo -e "\e[31mThe code of this Bash function is flawed.\e[39m"
            echo "GUID=='5afd6e31-9ac3-4891-a5a0-8360902038e7'"
            echo ""
        fi
    fi
    #------------------------------
...
func_mmmv_assert_error_code_zero_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "GUID=='056c9245-7f52-46b3-84a0-8360902038e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$S_ERR_CODE" != "0" ];then
        ...
        echo "GUID=='22ad96a1-4ccb-4804-b490-8360902038e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
...
func_mmmv_assert_error_code_zero_t2(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "but it is expected to be a GUID."
        echo "Aborting script."
        echo "GUID=='b53587ce-a869-4d5b-9190-8360902038e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        exit 1
    ...
    if [ "$S_ERR_CODE" != "0" ];then
        ...
        echo "Something went wrong. Error code: $S_ERR_CODE"
        echo -e "\e[31mAborting script. \e[39m"
        echo "GUID=='a2cdca1a-2501-4444-b490-8360902038e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        exit 1
...
func_mmmv_exc_verify_S_FP_ORIG_t1() {
    if [ "$S_FP_ORIG" == "" ]; then
        ...
        echo ""
        echo "Aborting script."
        echo "GUID=='5055b5cf-8767-431f-8480-8360902038e7'"
        echo ""
    ...
    if [ ! -e "$S_FP_ORIG" ]; then
        ...
        echo -e "\e[31mAborting script. \e[39m"
        echo "GUID=='5e3a2b05-d513-440e-8680-8360902038e7'"
        echo ""
        exit 1 # exit with an error
    fi
    #------------------------
    if [ ! -d "$S_FP_ORIG" ]; then
        ...
        echo "contains the script that prints this error message."
        echo -e "\e[31mAborting script. \e[39m"
        echo "GUID=='40113b3a-5151-4694-a170-8360902038e7'"
        echo ""
        exit 1 # exit with an error
    fi
} # func_mmmv_exc_verify_S_FP_ORIG_t1
...
func_mmmv_exc_verify_S_FP_ORIG_t2(){
    if [ "$FUNC_MMMV_EXC_VERIFY_S_FP_ORIG_T2_S_FB_ORIG_ALREADY_VERIFIED" != "t" ]; then
        if [ "$FUNC_MMMV_EXC_VERIFY_S_FP_ORIG_T2_S_FB_ORIG_ALREADY_VERIFIED" != "f" ]; then
            ...
            echo ""
            echo "has a domain of {\"f\", \"t\"}."
            echo "GUID=='67f12648-5c74-4543-a270-8360902038e7'"
            echo ""
        else
            func_mmmv_exc_verify_S_FP_ORIG_t1
...
func_mmmv_cd_S_FP_ORIG_and_exit_t1(){
    ...
    cd "$S_FP_ORIG"
    func_mmmv_assert_error_code_zero_t2 "$?" \
        "b3bf3f73-b5ab-48d0-8f81-8360902038e7"
    exit 0
} # func_mmmv_cd_S_FP_ORIG_and_exit_t1
...
func_mmmv_assert_nonempty_string_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then 
        ...
        echo ""
        echo "but it is expected to be a GUID."
        echo "GUID=='8359d3a5-32f4-4ed8-9270-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$S_VARIABLE_NAME_IN_CALLING_CODE" == "" ]; then 
        ...
        echo "    S_VARIABLE_NAME_IN_CALLING_CODE==\"\""
        echo ""
        echo "GUID=='356d1deb-b459-4250-8260-8360902038e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$S_IN" == "" ]; then 
        ...
        echo ""
        echo "but it is expected to be something other than an empty string."
        echo "GUID=='b92db024-127e-4ee9-8160-8360902038e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
...
func_mmmv_assert_sbvar_domain_t_f_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then 
        ...
        echo ""
        echo "but it is expected to be a GUID."
        echo "GUID=='f85e9541-fc2a-40cb-a250-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1 # exiting with an error
    ...
    if [ "$S_VARIABLE_NAME_IN_CALLING_CODE" == "" ]; then 
        ...
        echo "    S_VARIABLE_NAME_IN_CALLING_CODE==\"\""
        echo ""
        echo "GUID=='6217f15e-7dc9-40e9-b150-8360902038e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$SB_VARIABLE_VALUE" != "t" ]; then 
        if [ "$SB_VARIABLE_VALUE" != "f" ]; then 
            ...
            echo ""
            echo "but it is expected to be either \"t\" or \"f\"."
            echo "GUID=='23293e30-2169-4e39-a340-8360902038e7'"
            echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
...
func_mmmv_assert_file_exists_t1() {
    ...
    if [ "$SB_LACK_OF_PARAMETERS" == "t" ]; then
        ...
        echo "GUID=='a53f3251-f05c-4007-8f40-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1 # exiting with an error
        ...
        if [ "$SB_LACK_OF_PARAMETERS" != "f" ]; then
            ...
            echo "GUID=='792f1e5d-24a7-475d-a140-8360902038e7'"
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
        fi
    ...
    if [ "$SB_OPTIONAL_BAN_SYMLINKS" == "" ]; then
        ...
        if [ "$SB_OPTIONAL_BAN_SYMLINKS" != "t" ]; then
            if [ "$SB_OPTIONAL_BAN_SYMLINKS" != "f" ]; then
                ...
                echo "are: \"t\", \"f\", \"\"."
                echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
                echo "GUID=='27fc6c72-2b29-4a15-8230-8360902038e7'"
                echo ""
                #--------
                cd "$S_FP_ORIG"
                exit 1 # exiting with an error
    ...
    if [ ! -e "$S_FP" ]; then
        if [ -h "$S_FP" ]; then
            ...
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='c30c8615-637d-4941-a330-8360902038e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
            ...
            echo -e "\e[31mdoes not exist\e[39m."
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='5d027864-2255-474f-9b20-8360902038e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
        ...
        if [ -d "$S_FP" ]; then
            ...
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='b21b0a15-f033-4537-8320-8360902038e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
            ...
            if [ "$SB_OPTIONAL_BAN_SYMLINKS" == "t" ]; then
                if [ -h "$S_FP" ]; then 
                    ...
                    echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='b31605ee-12f7-4bc8-a220-8360902038e7'"
                    echo ""
                    #--------
                    cd "$S_FP_ORIG"
                    exit 1 # exiting with an error
...
func_mmmv_assert_folder_exists_t1() {
    ...
    if [ "$SB_LACK_OF_PARAMETERS" == "t" ]; then
        ...
        echo "GUID=='51fd4b5f-2697-4a4f-b210-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1 # exiting with an error
        ...
        if [ "$SB_LACK_OF_PARAMETERS" != "f" ]; then
            echo -e "\e[31mThis code is flawed. \e[39m"
            echo "GUID=='7ca0a250-e64f-4f53-a510-8360902038e7'"
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
        fi
    ...
    if [ "$SB_OPTIONAL_BAN_SYMLINKS" == "" ]; then
        ...
        if [ "$SB_OPTIONAL_BAN_SYMLINKS" != "t" ]; then
            if [ "$SB_OPTIONAL_BAN_SYMLINKS" != "f" ]; then
                ...
                echo "are: \"t\", \"f\", \"\"."
                echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
                echo "GUID=='d534d659-5641-4439-a410-8360902038e7'"
                echo ""
                #--------
                cd "$S_FP_ORIG"
                exit 1 # exiting with an error
    ...
    if [ ! -e "$S_FP" ]; then
        if [ -h "$S_FP" ]; then
            ...
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='4839ef94-a64b-4361-b310-8360902038e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
            ...
            echo -e "\e[31mdoes not exist\e[39m."
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='3993c440-ad00-4cdc-a110-8360902038e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
        ...
        if [ ! -d "$S_FP" ]; then
            ...
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='3bcfe653-58a4-4601-9400-8360902038e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
            ...
            if [ "$SB_OPTIONAL_BAN_SYMLINKS" == "t" ]; then
                if [ -h "$S_FP" ]; then 
                    ...
                    echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='140f141b-0954-4f94-b200-8360902038e7'"
                    echo ""
                    #--------
                    cd "$S_FP_ORIG"
                    exit 1 # exiting with an error
...
func_mmmv_exit_if_not_on_path_t2() { # S_COMMAND_NAME
    ...
    if [ "$S_LOCAL_VARIABLE" == "" ]; then
        ...
        echo "GUID=='19425b85-190a-469e-9800-8360902038e7'"
        echo ""
        cd "$S_FP_ORIG"
        exit 1;
    fi
...
func_mmmv_exc_exit_with_an_error_t1(){
    ...
    echo "GUID=='19b2eb62-7eeb-4790-9400-8360902038e7'"
    echo ""
    cd "$S_FP_ORIG"
    exit 1 # exit with an error
} # func_mmmv_exc_exit_with_an_error_t1
...
func_mmmv_exc_exit_with_an_error_t2(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then 
        ...
        echo "Aborting script."
        echo "GUID=='c60fb938-3b42-4457-b400-8360902038e7'"
        echo ""
        cd "$S_FP_ORIG"
        exit 1 # exit with an error
    else
        ...
        echo "Aborting script."
        echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo "GUID=='4507f43b-49b4-46e0-92ff-8360902038e7'"
        echo ""
        cd "$S_FP_ORIG"
        exit 1 # exit with an error
    fi
...
func_mmmv_exc_determine_Awk_command_t1() { # prefers the GNU Awk to the BSD Awk
    ...
    if [ "$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" != "" ]; then
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            ...
            "SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" \
            "a4224254-4bd1-4672-9581-8360902038e7" 
    ...
    if [ "$SB_REINIT" == "t" ]; then
        ...
        local SB_THROW="f"
        local S_TMP_0="472b1454-f7ce-468c-a451-8360902038e7"
        ...
        if [ "$SB_THROW" == "t" ]; then
            ...
            echo "The execution of this Bash script is aborted."
            echo "GUID=='4e5bc093-3646-4f5d-b4ff-8360902038e7'"
            echo ""
            cd "$S_FP_ORIG"
            exit 1;
        fi
...
func_mmmv_exc_determine_sed_command_t1() { # prefers the GNU sed to the BSD sed
    ...
    if [ "$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" != "" ]; then
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            "$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" \
            "SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" \
            "feb11825-50a0-43dc-8351-8360902038e7" 
        SB_AVOID_REINIT="$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED"
    fi
    #----------------------------------------------------------------------
    local SB_REINIT="t"
    ...
    if [ "$SB_REINIT" == "t" ]; then
        ...
        local SB_THROW="f"
        local S_TMP_0="c121ed27-9673-4d02-a451-8360902038e7"
        local S_FP_0="/tmp/this/proB9bably/do00es/noTt/eXXXist/ㄫ/$S_TMP_0"
        #------------------------------------------------------------------
        ...
        if [ "$SB_THROW" != "f" ]; then
            ...
            echo "The execution of this Bash script is aborted."
            echo "GUID=='d92b0313-9299-429f-b5ff-8360902038e7'"
            echo ""
            cd "$S_FP_ORIG"
            exit 1;
        fi
...
func_mmmv_exc_is_file_t1() {
    ...
    if [ ! -e "$S_FP_CANDIDATE" ]; then 
        ...
        echo ""
        echo -e "\e[31mdoes not exist\e[39m."
        echo "GUID=='39bfd5e2-6046-499a-95ff-8360902038e7'"
    ...
    if [ -d "$S_FP_CANDIDATE" ]; then 
        ...
        echo "GUID=='a439b585-a60f-4078-92ef-8360902038e7'"
        echo "Aborting without doing anything."
        echo ""
        exit 1 # exit with an error
    fi
...
func_mmmv_exc_is_folder_t1() {
    ...
    if [ ! -e "$S_FP_CANDIDATE" ]; then 
        ...
        echo ""
        echo -e "\e[31mdoes not exist\e[39m."
        echo "GUID=='f838a441-ec06-4e82-94ef-8360902038e7'"
        echo "Aborting without doing anything."
        echo ""
        exit 1 # exit with an error
    fi
    if [ ! -d "$S_FP_CANDIDATE" ]; then 
        ...
        echo "GUID=='843fe847-3caa-4094-94ef-8360902038e7'"
        echo "Aborting without doing anything."
        echo ""
        exit 1 # exit with an error
    fi
...
func_mmmv_create_folder_t1(){
    ...
    if [ "$S_FP_FOLDER" == "" ]; then
        ...
        echo "Aborting script."
        echo "GUID=='759d974d-ea98-4e6a-93ef-8360902038e7'"
        echo ""
        cd "$S_FP_ORIG"
        exit 1 # exit with an error
    fi
    ...
    if [ -e "$S_FP_FOLDER" ]; then 
        if [ ! -d "$S_FP_FOLDER" ]; then 
            ...
            echo "Aborting script."
            echo "GUID=='16c262a1-13ba-4670-a2ef-8360902038e7'"
            echo ""
            cd "$S_FP_ORIG"
            exit 1 # exit with an error
        fi
        ...
        wait # just in case
        if [ "$S_TMP_0" != "0" ]; then 
            func_mmmv_exc_exit_with_an_error_t2 "3aa2a854-4056-42a0-a341-8360902038e7" \
                "S_FP_FOLDER==$S_FP_FOLDER"
        fi
        if [ ! -e "$S_FP_FOLDER" ]; then 
            func_mmmv_exc_exit_with_an_error_t2 "4edfa25d-4117-466d-b341-8360902038e7" \
...
func_mmmv_exc_assure_tmp_folder_existence_t1() {  # S_FP_TMP, S_GUID
    ...
    if [ "$S_GUID" == "" ]; then
        ...
        echo "GUID=='c2e9201c-9413-4225-a1df-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1 # exiting with an error
    ...
    if [ ! -e "$S_FP_TMP" ]; then
        if [ -h "$S_FP_TMP" ]; then
            ...
            func_mmmv_assert_error_code_zero_t1 \
                "$?" "b5847f3c-b3d3-4512-9131-8360902038e7"
            func_mmmv_wait_and_sync_t1
            if [ -h "$S_FP_TMP" ]; then
                echo ""
                echo "The path "
                ...
                echo "GUID==\"$S_GUID\""
                echo "GUID=='4baf1534-7f4b-4a4a-84df-8360902038e7'"
                echo ""
                #--------
                cd "$S_FP_ORIG"
                exit 1 # exiting with an error
        ...
        mkdir -p "$S_FP_TMP"
        func_mmmv_assert_error_code_zero_t1 \
            "$?" "37308cd1-9a5b-4c0c-8b31-8360902038e7"
        func_mmmv_wait_and_sync_t1
        func_mmmv_assert_folder_exists_t1 "$S_FP_TMP" \
            '2ab54351-a127-4248-a1df-8360902038e7'
    else
        if [ ! -d "$S_FP_TMP" ]; then
            echo ""
            if [ -h "$S_FP_TMP" ]; then
            ...
            echo "GUID==\"$S_GUID\""
            echo "GUID=='ca304e45-8e5b-46e9-81df-8360902038e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
...
func_mmmv_ln_create_hardlink_t1() { # S_FP_TARGET  S_FP_LINK
    ...
    if [ "$SB_THROW_ON_INVALID_DATA" == "" ]; then
        ...
        if [ "$SB_THROW_ON_INVALID_DATA" != "t" ]; then
            if [ "$SB_THROW_ON_INVALID_DATA" != "f" ]; then
                ...
                echo ""
                echo "Aborting script."
                echo "GUID=='7e7c5715-43a8-4e51-a1df-8360902038e7'"
                echo ""
    ...
    if [ -e "$S_FP_LINK" ]; then 
        if [ -d "$S_FP_LINK" ]; then # folder or a symlink to a folder
            if [ ! -h "$S_FP_LINK" ]; then # not a symlink, therefore a folder
                ...
                echo "    $S_FP_TARGET"
                echo ""
                echo "GUID=='19d18f33-eb5e-4eac-81cf-8360902038e7'"
                echo ""
                if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                    exit 1
                fi
        ...
        if [ "$SB_DO_NOT_CREATE_THE_HARDLINK" == "f" ]; then
            ...
            echo "GUID=='3f02f695-2778-4a33-a2cf-8360902038e7'"
            echo ""
            if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                exit 1
            fi
        ...
        if [ "$SB_DO_NOT_CREATE_THE_HARDLINK" == "f" ]; then
            if [ -h "$S_FP_LINK" ]; then # a broken symlink, therefore NOT missing
                ...
                echo "must not exist before the call to this function."
                echo "GUID=='54984040-ec37-4a71-94cf-8360902038e7'"
                echo ""
                if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                    exit 1
                fi
        ...
        if [ -e "$S_FP_TARGET" ]; then
            if [ -d "$S_FP_TARGET" ]; then # a folder or a symlink to a folder
                if [ ! -h "$S_FP_TARGET" ]; then # not a symlink, therefore a folder
                    ...
                    echo "    $S_FP_LINK"
                    echo ""
                    echo "GUID=='0ea7b75e-bb34-4e17-91cf-8360902038e7'"
                    echo ""
                    if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                        exit 1
                    fi
            ...
            if [ ! -h "$S_FP_TARGET" ]; then # not a symlink, therefore missing
                ...
                echo "    $S_FP_LINK"
                echo ""
                echo "GUID=='af6a7ac2-2d62-4189-a3cf-8360902038e7'"
                echo ""
                if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                    exit 1
                fi
    ...
    #----------------------------------------------------------------------
    local S_TMP_0="not_set_yet GUID=='2845d351-00cc-480c-85bf-8360902038e7'"
    if [ "$SB_DO_NOT_CREATE_THE_HARDLINK" == "f" ]; then
        ...
        if [ "$S_TMP_0" != "0" ]; then
            ...
            echo "GUID=='90b36740-3b78-4018-a1bf-8360902038e7'"
            echo ""
            if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                exit 1
            fi
        ...
        if [ "$SB_DO_NOT_CREATE_THE_HARDLINK" == "f" ]; then
            ...
            if [ -h "$S_FP_TARGET" ]; then
                ...
                if [ ! -h "$S_FP_LINK" ]; then
                    ...
                    echo "GUID=='6b0f764b-af6d-4294-b3bf-8360902038e7'"
                    echo ""
                    S_TMP_0="t"
                else
                    if [ -e "$S_FP_TARGET" ]; then # symlink to a folder or a file
                        if [ ! -e "$S_FP_LINK" ]; then
                            echo ""
                            echo "Problem detection branch marker "
                            echo "GUID=='f829644e-77bd-40b8-a5bf-8360902038e7'"
                            echo ""
                            S_TMP_0="t"
                        else
                            if [ -d "$S_FP_TARGET" ]; then
                                if [ ! -d "$S_FP_LINK" ]; then
                                    echo ""
                                    echo "Problem detection branch marker "
                                    echo "GUID=='f0beb31e-681f-4343-a2af-8360902038e7'"
                                    echo ""
                                    S_TMP_0="t"
                                fi
                            else
                                if [ -d "$S_FP_LINK" ]; then
                                    echo ""
                                    echo "Problem detection branch marker "
                                    echo "GUID=='556ece6d-1e49-4b4d-b3af-8360902038e7'"
                                    echo ""
                                    S_TMP_0="t"
                                fi
                            fi
                        ...
                        if [ -e "$S_FP_LINK" ]; then
                            echo ""
                            echo "Problem detection branch marker "
                            echo "GUID=='73e4601e-17de-43af-82af-8360902038e7'"
                            echo ""
                            S_TMP_0="t"
                        fi
                    fi
                ...
                if [ ! -e "$S_FP_TARGET" ]; then # just an extra test
                    echo ""
                    echo "Problem detection branch marker "
                    echo "GUID=='7eb2085b-8d58-483e-81af-8360902038e7'"
                    echo ""
                    S_TMP_0="t"
                else
                    if [ -d "$S_FP_TARGET" ]; then # just an extra test
                        echo ""
                        echo "Problem detection branch marker "
                        echo "GUID=='2c3db544-75c2-4722-b3af-8360902038e7'"
                        echo ""
                        S_TMP_0="t"
                    else
                        if [ -h "$S_FP_LINK" ]; then
                            echo ""
                            echo "Problem detection branch marker "
                            echo "GUID=='dc6ae843-abe4-477b-859f-8360902038e7'"
                            echo ""
                            S_TMP_0="t"
                        else
                            if [ ! -e "$S_FP_LINK" ]; then
                                echo ""
                                echo "Problem detection branch marker "
                                echo "GUID=='ac19c146-0c01-48f4-859f-8360902038e7'"
                                echo ""
                                S_TMP_0="t"
                            else
                                if [ -d "$S_FP_LINK" ]; then
                                    echo ""
                                    echo "Problem detection branch marker "
                                    echo "GUID=='ef98ee4f-969f-4b74-b19f-8360902038e7'"
                                    echo ""
                                    S_TMP_0="t"
                                fi
                            fi
            ...
            if [ "$S_TMP_0" == "t" ]; then
                ...
                echo "GUID=='4cebd313-f8a5-4d9e-b19f-8360902038e7'"
                echo ""
                if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                    exit 1
                fi
                ...
                if [ "$S_TMP_0" != "f" ]; then
                    ...
                    echo "Aborting script."
                    echo "GUID=='466cea64-f917-4e40-919f-8360902038e7'"
                    echo ""
                    exit 1
                fi
            fi
        ...
        if [ "$SB_DO_NOT_CREATE_THE_HARDLINK" != "t" ]; then
            ...
            echo -e "\e[31mThe implementation of this function is flawed. \e[39m"
            echo "Aborting script."
            echo "GUID=='e449a21e-363d-4df7-a28f-8360902038e7'"
            echo ""
            exit 1
        fi
    fi
...
func_mmmv_assert_environment_variable_set_t1() { 
    ...
    if [ "$S_ENVIR_VALUE" == "" ]; then
        ...
        echo "GUID=='7183b714-daba-4d8d-858f-8360902038e7'"
        echo ""
        exit 1 # exit with an error
    #else 
...
func_mmmv_iterate_over_array_02n_t1() {
    ...
    if [ "$S_ARRAY_VARIABLE_NAME" == "" ]; then
        ...
        echo "GUID=='5e5e3f53-973b-411f-a28f-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1
    ...
    if [ "$S_ITERATION_FUNCTION_NAME" == "" ]; then
        ...
        echo "GUID=='3d074b24-e4e2-45ea-b38f-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1
...
func_mmmv_include_bashfile_if_possible_t1(){ # S_FP_BASHFILE S_GUID_CANDIDATE SB_THROW_ON_ERROR
    ...
    if [ "$SB_THROW_ON_ERROR" == "" ]; then
        ...
        if [ "$SB_THROW_ON_ERROR" != "t" ]; then
            if [ "$SB_THROW_ON_ERROR" != "f" ]; then
                ...
                echo "GUID=='151f7736-0ab5-47e4-837f-8360902038e7'"
                echo ""
            fi
        fi
    fi
    ...
    if [ "$S_FP_BASHFILE" == "" ]; then
        ...
        echo "GUID=='d1365f20-8d1c-49ca-a37f-8360902038e7'"
        echo ""
        if [ "$SB_THROW_ON_ERROR" == "t" ]; then
            exit 1
        fi
    ...
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        if [ ! -e "$S_FP_BASHFILE" ]; then
            ...
            echo "GUID=='80448a37-5b33-4f12-957f-8360902038e7'"
            echo ""
            if [ "$SB_THROW_ON_ERROR" == "t" ]; then
                exit 1
            fi
    ...
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        if [ -d "$S_FP_BASHFILE" ]; then
            ...
            echo "GUID=='53e72919-6f81-4ccf-a17f-8360902038e7'"
            echo ""
            if [ "$SB_THROW_ON_ERROR" == "t" ]; then
                exit 1
            fi
    ...
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        ...
        if [ "$SB_INCLUSION_POSSIBLE" != "f" ]; then
            ...
            echo "GUID=='73296c15-79a9-4a94-967f-8360902038e7'"
            echo ""
            if [ "$SB_THROW_ON_ERROR" == "t" ]; then
                exit 1 
            fi
...
func_mmmv_include_bashfile_if_possible_t2(){ # S_FP_BASHFILE S_GUID_CANDIDATE 
    ...
    if [ "$S_FP_BASHFILE" == "" ]; then
        ...
        echo "GUID=='0b607a3e-9d1c-472d-b36f-8360902038e7'"
        echo ""
    fi
    #-----------------------------------------
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        if [ ! -e "$S_FP_BASHFILE" ]; then
            ...
            echo "GUID=='385a7dc2-e408-4fe0-a76f-8360902038e7'"
            echo ""
        fi
    fi
    #-----------------------------------------
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        if [ -d "$S_FP_BASHFILE" ]; then
            ...
            echo "GUID=='9f224f19-f125-4818-b26f-8360902038e7'"
            echo ""
        fi
    fi
    #----------------------------------------------------------------------
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        ...
        if [ "$SB_INCLUSION_POSSIBLE" != "f" ]; then
            ...
            echo "GUID=='34520216-e80d-4fff-a36f-8360902038e7'"
            echo ""
        fi
    fi
...
func_mmmv_assert_exists_on_path_t1() {
    ...
    if [ "$S_TMP_1" == "" ]; then
        ...
        echo "GUID=='5a026a40-3c28-449a-826f-8360902038e7'"
        echo ""
        cd "$S_FP_ORIG"
        exit 1 # exit with an error
    fi
...
func_mmmv_ln_create_or_overwrite_symlink_t1() { # S_FP_TARGET  S_FP_LINK
    ...
    if [ -e "$S_FP_LINK" ]; then
        if [ ! -h "$S_FP_LINK" ]; then # not a symlink
            ...
            echo ""
            echo "PWD==`pwd`"
            echo "GUID=='8fad6d4f-2b64-47a5-a46f-8360902038e7'"
            echo ""
            exit 1 # exit with an error
        fi
    ...
    if [ "$SB_DELETE_OLD_LINK" == "t" ]; then
        rm -f $S_FP_LINK
        func_mmmv_assert_error_code_zero_t1 "$?" \
            "18dd0514-cf6a-4647-b121-8360902038e7"
        func_mmmv_wait_and_sync_t1
        if [ -e "$S_FP_LINK" ]; then
            echo ""
            echo ""
            ...
            echo ""
            echo "PWD==`pwd`"
            echo "GUID=='2c6c2d3a-9080-46f7-816f-8360902038e7'"
            echo ""
            echo ""
            exit 1 # exit with an error
        fi
    ...
    $S_CMD_LN
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "64787847-7608-436c-a421-8360902038e7"
    func_mmmv_wait_and_sync_t1
    if [ ! -e "$S_FP_LINK" ]; then
        echo ""
        echo ""
        ...
        echo ""
        echo "PWD==`pwd`"
        echo "GUID=='228b92d3-33d8-4fd5-876f-8360902038e7'"
        echo ""
        echo ""
        exit 1 # exit with an error
    fi
...
func_mmmv_determine_operatingsystem_t1() {
    ...
    if [ "$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" == "" ]; then
        ...
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            "$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" \
            "SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" \
            "db957b22-ea62-479c-9221-8360902038e7" 
    fi
...
func_mmmv_assert_Linux_or_BSD_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "GUID=='c5567896-772e-453e-af5f-8360902038e7'"
        echo ""
        # if [ "$S_FP_ORIG" != "" ]; then
        #     func_mmmv_exc_verify_S_FP_ORIG_t1
        #     cd "$S_FP_ORIG"
    ...
    if [ "$S_TMP_0" == "" ]; then
        ...
        echo ""
        echo "GUID=='5eefe141-dc99-40c3-825f-8360902038e7'"
        echo ""
        # if [ "$S_FP_ORIG" != "" ]; then
        #     func_mmmv_exc_verify_S_FP_ORIG_t1
        #     cd "$S_FP_ORIG"
...
func_mmmv_verify_that_internet_connection_exists_but_do_not_exit_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo ""
        echo "but it is expected to be a GUID."
        echo "GUID=='a41b6dca-8392-47cd-a65f-8360902038e7'"
        echo ""
    fi
    #----------------------------------------------------------------------
            ...
            if [ "$SB_DISPLAY_NONERROR_FEEDBACK" != "f" ]; then
                ...
                if [ "$S_GUID_CANDIDATE" != "" ]; then
                    ...
                    func_mmmv_assert_sbvar_domain_t_f_but_do_not_exit_t1 \
                        "$SB_DISPLAY_NONERROR_FEEDBACK" \
                        "SB_DISPLAY_NONERROR_FEEDBACK" \
                        "299d678d-ef36-4f76-a411-8360902038e7"
                fi
                SB_DISPLAY_NONERROR_FEEDBACK="f"
                #----------------------------------------
            fi
...
# RENESSAATOR_BLOCK_END
    ...
    if [ "$SB_DOMAIN_IS_REACHABLE" == "f" ]; then
        ...
        if [ "$SB_DISPLAY_NONERROR_FEEDBACK" == "t" ]; then
            ...
            echo "GUID=='3767cb55-c3cb-4859-b15f-8360902038e7'"
            if [ "$S_GUID_CANDIDATE" != "" ]; then
                echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
            fi
        fi
...
func_mmmv_assert_internet_connection_exists_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "but it is expected to be a GUID."
        echo "Aborting script."
        echo "GUID=='f1d82d5d-ca01-44f4-b15f-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1
    ...
    if [ "$SB_OK_TO_CACHE" == "" ]; then
        ...
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            ...
            "4f4c775d-6ee3-4ada-a311-8360902038e7"
    fi
    #----------------------------------------------------------------------
    if [ "$SB_DISPLAY_NONERROR_FEEDBACK" == "" ]; then
        SB_DISPLAY_NONERROR_FEEDBACK="f"
    ...
    if [ "$SB_STUDY_INTERNET_AVAILABILITY" == "t" ]; then
        ...
        # The 
        func_mmmv_verify_that_internet_connection_exists_but_do_not_exit_t1 \
            "8604c158-89d2-487e-b4f0-8360902038e7" \
            "$SB_DISPLAY_NONERROR_FEEDBACK"
        ...
        if [ "$SB_VERIFICATION_FAILED" == "t" ]; then
            ...
            if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
                ...
                func_mmmv_assert_sbvar_domain_t_f_t1 \
                    ...
                    "SB_VERIFICATION_FAILED" \
                    "7bc44b5f-7b04-4ef8-b5f0-8360902038e7"
            fi
        fi
        #----------------------------------------
    ...
    if [ "$SB_INTERNET_AVAILABLE" == "f" ]; then
        ...
        echo "GUID=='91144e82-0b80-4b58-845f-8360902038e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
...
func_mmmv_assert_GUI_applications_can_be_launched_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "but it is expected to be a GUID."
        echo "Aborting script."
        echo "GUID=='26132663-a568-47e5-b85f-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1
    ...
    if [ "$SB_OK_TO_CACHE" == "" ]; then
        ...
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            "$SB_OK_TO_CACHE" "SB_OK_TO_CACHE" \
            "2fa4abe2-1c5a-4a4d-a3e0-8360902038e7"
    fi
    #----------------------------------------------------------------------
    if [ "$SB_DISPLAY_NONERROR_FEEDBACK" == "" ]; then
        SB_DISPLAY_NONERROR_FEEDBACK="f"
    ...
    if [ "$SB_OK_TO_CACHE" == "t" ]; then
        if [ "$SB_FUNC_MMMV_ASSERT_GUI_APPLICATIONS_CAN_BE_LAUNCHED_T1_RESULT_CACHED" == "t" ]; then
            ...
            if [ "$SB_FUNC_MMMV_ASSERT_GUI_APPLICATIONS_CAN_BE_LAUNCHED_T1_GUI_IS_LAUNCHABLE" == "f" ]; then
                ...
                echo "Aborting script."
                echo "GUID=='f5545d2b-b067-4cde-b15f-8360902038e7'"
                echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
                echo ""
                #--------
                cd "$S_FP_ORIG"
    ...
    if [ "$SB_RUN_TEST" == "t" ]; then
        ...
        if [ "$S_TMP_0" != "124" ]; then
            ...
            echo "Aborting script."
            echo "GUID=='7d2a9133-ad1e-4457-a14f-8360902038e7'"
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo ""
            #--------
            cd "$S_FP_ORIG"
...
func_mmmv_exc_initialize_wine_C_drive_if_needed_t1(){
    ...
    if [ "$SB_DISPLAY_NONERROR_FEEDBACK" == "" ]; then
        ...
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            "$SB_DISPLAY_NONERROR_FEEDBACK" "SB_DISPLAY_NONERROR_FEEDBACK" \
            "814aae65-0adc-41a2-93d0-8360902038e7" 
    fi
    #----------------------------------------------------------------------
    ...
    if [ ! -d "$S_FP_C" ]; then # for speed optimisation
        if [ ! -e "$S_FP_C" ]; then
            ...
            func_mmmv_assert_GUI_applications_can_be_launched_t1 \
                "72459d3f-6dfb-4e83-82c0-8360902038e7" \
            ...
            func_mmmv_assert_error_code_zero_t1 "$?" \
                "1c2a5a22-f9d3-40e0-91b0-8360902038e7"
            func_mmmv_wait_and_sync_t1
            func_mmmv_assert_folder_exists_t1 "$S_FP_C" \
                "0637f210-96f2-4c0a-95b0-8360902038e7" \
                "$SB_OPTIONAL_BAN_SYMLINKS"
            if [ "$SB_DISPLAY_NONERROR_FEEDBACK" == "t" ]; then
            ...
            #--------------------------------------------------------------
            func_mmmv_assert_folder_exists_t1 "$S_FP_C" \
                "e47b6342-3c6a-4dba-91a0-8360902038e7" \
                "$SB_OPTIONAL_BAN_SYMLINKS"
            #--------------------------------------------------------------
        fi
    fi
...
func_mmmv_uncompress_tar_dot_foo_and_enter_t1(){
    ...
    if [ "$SB_COMPRESSION_TYPE_RECOGNIZED" != "t" ]; then
        ...
        echo "Aborting script."
        echo "GUID=='1f22a0d5-1fea-4969-a14f-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1 # exiting with an error
    ...
    func_mmmv_assert_folder_exists_t1 "$S_FP_PARENT_FOLDER" \
        "ad54a02d-51b9-44a1-b2a0-8360902038e7"
    cd $S_FP_PARENT_FOLDER
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "20a455c7-2d23-4269-91a0-8360902038e7"
    #----------------------------------------
    ...
    if [ "$SB_COMPRESSIONLESS_TAR" == "f" ]; then
        func_mmmv_assert_file_exists_t1 "$S_FP_COMPRESSED" \
            "eb4ac549-114b-40a2-a290-8360902038e7"
        $S_CMD_UNCOMPRESS $S_FP_COMPRESSED
        func_mmmv_assert_error_code_zero_t1 "$?" \
            "9510c419-bcac-4024-8490-8360902038e7"
        func_mmmv_wait_and_sync_t1
    fi
    #----------------------------------------
    func_mmmv_assert_file_exists_t1 "$S_FP_TAR" \
        "1e82cf85-bb76-4a49-9280-8360902038e7"
    $S_CMD_NICE_PREFIX tar -xf $S_FP_TAR
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "1dc1f2a4-7315-4d83-8180-8360902038e7"
    func_mmmv_wait_and_sync_t1
    #----------------------------------------
    func_mmmv_assert_folder_exists_t1 "$S_FP_NEXT_PARENT_FOLDER" \
        "acd94b3b-d43c-44fa-a580-8360902038e7"
...
func_mmmv_s_owner_of_a_file_or_folder_t1(){
    ...
    if [ ! -e "$S_FP_IN" ]; then
        if [ -h "$S_FP_IN" ]; then
            func_mmmv_exc_exit_with_an_error_t2 \
                "45d48219-d929-492b-9270-8360902038e7" \
                "The $S_FP_IN is a broken symlink."
        else
            func_mmmv_exc_exit_with_an_error_t2 \
                "d227b6a9-c30e-4ef5-8870-8360902038e7" \
...
func_mmmv_exc_block_device_ID_to_device_file_name_t1(){ # 
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "but it is expected to be a GUID."
        echo "Aborting script."
        echo "GUID=='b3a41240-337e-4348-934f-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1
    ...
    if [ "$S_BLOCK_DEVICE_ID_SUBPART_CANDIDATE" == "" ]; then
        ...
        echo "Aborting script."
        echo "GUID=='3b36fc45-e1fb-41f8-a14f-8360902038e7'"
        echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$S_TMP_0" != "t" ]; then
        ...
        echo "Aborting script."
        echo "GUID=='4f09c23e-8e8e-4d2d-844f-8360902038e7'"
        echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$S_FP_DEVICE_FILE" == "" ]; then
        ...
        echo "Aborting script."
        echo "GUID=='c15eeafe-56e4-438c-9d4f-8360902038e7'"
        echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
        echo ""
        #--------
        cd "$S_FP_ORIG"
...
func_first_use_message(){
    ...
    echo "GUID=='9149cf5c-924f-42fa-9a4f-8360902038e7'"
    echo ""
    #------------------------------
    cd "$S_FP_ORIG"
    exit 1
...
func_display_help_message(){
    ...
    echo "are:"
    echo ""
    echo -e "    S_FP_CLONESCRIPT=\"\e[96m$S_FP_CLONESCRIPT\e[39m\""
    echo ""
    echo -e "    S_URL_PREFIX=\"\e[96m$S_URL_PREFIX\e[39m\""
    echo ""
    echo -e "    SI_MAX_N_OF_JSON_PAGES=\"\e[96m$SI_MAX_N_OF_JSON_PAGES\e[39m\""
    echo ""
...
func_check_for_some_dependencies(){
    ...
    #func_mmmv_assert_exists_on_path_t1 "git" # not needed for generating the clonescript
    ...
    func_mmmv_assert_exists_on_path_t1 "wc"
    #------------------------------
...
func_display_help_message_and_exit_if_needed(){
    ...
    if [ "$S_ARGV_0" != "" ]; then
        if [ "`echo \"$S_ARGV_0\" | grep -E '^((([-][-]?)?[hH][eE][lL][pP])|([-]?[hH?]))$' `" == "" ]; then
            ...
            echo "GUID=='1a5c317e-af3d-4d8c-853f-8360902038e7'"
...
func_initialize_configuration_by_initializing_global_variables(){
    ...
    func_mmmv_init_s_timestamp_if_not_inited_t1
    #----------------------------------------------------------------------
    #S_FP_CLONESCRIPT_PARENT_FOLDER="$S_FP_DIR/generated_clonescripts"
    S_FP_CLONESCRIPT_PARENT_FOLDER="`pwd`/generated_clonescripts"
    S_FP_CLONESCRIPT="$S_FP_CLONESCRIPT_PARENT_FOLDER/koodivaramu_eesti_ee_clonescript_$S_TIMESTAMP.bash"
    S_URL_PREFIX="https://koodivaramu.eesti.ee"
    SI_MAX_N_OF_JSON_PAGES="4000" # each JSON page contains 50 URLs.
    #----------------------------------------------------------------------
    # If the mmmv_cre_temporary_file_t1 is on PATH, then the 
    S_FP_URLLIST_TMP_0="/tmp/koodivaramu_eesti_ee_tmp_URLlist_0_$S_TIMESTAMP.txt"
    # and 
    S_FP_URLLIST_TMP_1="/tmp/koodivaramu_eesti_ee_tmp_URLlist_1_$S_TIMESTAMP.txt"
    # will be overriden.
    #----------------------------------------------------------------------
...
#--------------------------------------------------------------------------
SB_LOOP_01_ACTIVE="t" # domain: {"t","f"}

func_loop_01_iteration_part_01(){
    #------------------------------
    local SI_PAGE="$1"
    # Test Bash line:
    #
    #     curl "https://koodivaramu.eesti.ee/api/v4/projects?per_page=5&page=1" | jq '.[].ssh_url_to_repo' | sed -e 's/^/nice -n 5 git clone --recursive /g'
    #
    $S_CMD_PREFIX_NICE curl "$S_URL_PREFIX/api/v4/projects?per_page=50&page=$SI_PAGE" | \
    $S_CMD_PREFIX_NICE jq '.[].ssh_url_to_repo' > $S_FP_URLLIST_TMP_0
    # $S_CMD_PREFIX_NICE jq '.[].ssh_url_to_repo' | \
    # $S_CMD_PREFIX_NICE $S_CMD_GNU_SED -e \
    # 's/^/nice -n 5 git clone --recursive /g' >> $S_FP_CLONESCRIPT
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "2fe8b62e-60c3-4e69-b960-8360902038e7"
    func_mmmv_wait_and_sync_t1
    echo "" >> $S_FP_URLLIST_TMP_1 # adds a linebreak
    cat $S_FP_URLLIST_TMP_0 >> $S_FP_URLLIST_TMP_1
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "541cba1c-e79d-4171-a360-8360902038e7"
    func_mmmv_wait_and_sync_t1
    #------------------------------
    local SI_N_OF_LINES="`cat $S_FP_URLLIST_TMP_0 | wc --lines `"
    if [ "$SI_N_OF_LINES" == "0" ]; then
        SB_LOOP_01_ACTIVE="f"
    else
        if [ "$SI_N_OF_LINES" == "1" ]; then
            SB_LOOP_01_ACTIVE="f"
        else
            if [ "$SI_N_OF_LINES" == "2" ]; then
                SB_LOOP_01_ACTIVE="f"
            else
                if [ "$SI_N_OF_LINES" == "3" ]; then
                    SB_LOOP_01_ACTIVE="f"
                fi
            fi
        fi
...
func_loop_01(){
    #------------------------------
    local SI_N_OF_ITERATIONS="$1"
    local SI_PAGE=""
    SB_LOOP_01_ACTIVE="t"
    for ((i = 0; i < $SI_N_OF_ITERATIONS; i++)) do
        if [ "$SB_LOOP_01_ACTIVE" == "t" ]; then 
            SI_PAGE="$i"
            func_loop_01_iteration_part_01 "$SI_PAGE"
        else
            # https://phoenixnap.com/kb/bash-break
            # archival copy: https://archive.is/bj6LN
            break 1
        fi
    done
    #------------------------------
...
func_initialize_clonescript(){
    #----------------------------------------------------------------------
    func_mmmv_wait_and_sync_t1
    if [ -e "$S_FP_CLONESCRIPT" ]; then
        echo ""
        echo -e "\e[31mThe code of this script is flawed. \e[39m."
        echo "At this point in the control flow there should "
        echo "NOT exist a file or folder with the path of "
        echo ""
        echo "    $S_FP_CLONESCRIPT"
        echo ""
        echo "but it exists."
        echo "Aborting script."
        echo "GUID=='0c4f5d44-135c-4ecc-933f-8360902038e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1
    ...
    echo "#===========================================================================" >> $S_FP_CLONESCRIPT
    echo "# Script generation timestamp: $S_TIMESTAMP " >> $S_FP_CLONESCRIPT
    echo "#===========================================================================" >> $S_FP_CLONESCRIPT
    echo "S_FP_DIR=\"\$( cd \"\$( dirname \"\${BASH_SOURCE[0]}\" )\" && pwd )\"" >> $S_FP_CLONESCRIPT
    echo "S_FP_ORIG=\"\`pwd\`\"" >> $S_FP_CLONESCRIPT
    echo "S_TIMESTAMP=\"\`date +%Y\`_\`date +%m\`_\`date +%d\`_T_\`date +%H\`h_\`date +%M\`min_\`date +%S\`s\"" >> $S_FP_CLONESCRIPT
    echo "" >> $S_FP_CLONESCRIPT
    ...
    echo "        echo \"GUID=='2ce1c851-62d1-43c5-933f-8360902038e7'\"" >> $S_FP_CLONESCRIPT
    echo "        echo \"\"" >> $S_FP_CLONESCRIPT
    ...
    echo "        echo \"GUID=='8888cd25-89dc-497d-b53f-8360902038e7'\"" >> $S_FP_CLONESCRIPT
    ...
    echo "        echo \"GUID=='097bb938-c83b-4716-a43f-8360902038e7'\"" >> $S_FP_CLONESCRIPT
    echo "        echo \"S_GUID_CANDIDATE=='\$S_GUID_CANDIDATE'\"" >> $S_FP_CLONESCRIPT
    echo "        echo \"\"" >> $S_FP_CLONESCRIPT
    echo "        #--------" >> $S_FP_CLONESCRIPT
    echo "        cd \"\$S_FP_ORIG\"" >> $S_FP_CLONESCRIPT
    ...
    echo "} # func_mmmv_assert_error_code_zero_t1" >> $S_FP_CLONESCRIPT
    echo "" >> $S_FP_CLONESCRIPT
    echo "func_clone(){" >> $S_FP_CLONESCRIPT
    echo "    #------------------------------" >> $S_FP_CLONESCRIPT
    echo "    local S_URL=\"\$1\"" >> $S_FP_CLONESCRIPT
    echo "    #------------------------------" >> $S_FP_CLONESCRIPT
    echo "    nice -n 5 git clone --recursive \"\$S_URL\"" >> $S_FP_CLONESCRIPT
    echo "    func_mmmv_assert_error_code_zero_t1 \"\$?\" \\" >> $S_FP_CLONESCRIPT
    echo "        '52f37721-08c6-4b0a-ba3f-8360902038e7'" >> $S_FP_CLONESCRIPT
    echo "    wait ; sync ; wait " >> $S_FP_CLONESCRIPT
    echo "    #------------------------------" >> $S_FP_CLONESCRIPT
    echo "} # func_clone" >> $S_FP_CLONESCRIPT
    echo "" >> $S_FP_CLONESCRIPT
    echo "#===========================================================================" >> $S_FP_CLONESCRIPT
    echo "func_mmmv_exit_if_not_on_path_t2b \"git\" " >> $S_FP_CLONESCRIPT
    echo "cd \$S_FP_DIR" >> $S_FP_CLONESCRIPT
    echo "func_mmmv_assert_error_code_zero_t1 \"\$?\" \\" >> $S_FP_CLONESCRIPT
    echo "    '0e37d031-cdaa-4a28-853f-8360902038e7'" >> $S_FP_CLONESCRIPT
    echo "S_FP_REPOSITORIES=\"\$S_FP_DIR/cloned_repositories/cloned_at_\$S_TIMESTAMP\"" >> $S_FP_CLONESCRIPT
    echo "mkdir -p \$S_FP_REPOSITORIES" >> $S_FP_CLONESCRIPT
    echo "func_mmmv_assert_error_code_zero_t1 \"\$?\" \\" >> $S_FP_CLONESCRIPT
    echo "    '4e7fe199-89f4-448d-843f-8360902038e7'" >> $S_FP_CLONESCRIPT
    echo "wait ; sync ; wait " >> $S_FP_CLONESCRIPT
    echo "cd \$S_FP_REPOSITORIES" >> $S_FP_CLONESCRIPT
    echo "func_mmmv_assert_error_code_zero_t1 \"\$?\" \\" >> $S_FP_CLONESCRIPT
    echo "    'b978af46-f9e7-409b-a42f-8360902038e7'" >> $S_FP_CLONESCRIPT
    echo "echo \"\"" >> $S_FP_CLONESCRIPT
    echo "echo \"The repositories will be cloned to \"" >> $S_FP_CLONESCRIPT
    echo "echo \"\"" >> $S_FP_CLONESCRIPT
    echo "echo -e \"\\e[36m    \$S_FP_REPOSITORIES \\e[39m\"" >> $S_FP_CLONESCRIPT
    echo "echo \"\"" >> $S_FP_CLONESCRIPT
    echo "#===========================================================================" >> $S_FP_CLONESCRIPT
    echo "" >> $S_FP_CLONESCRIPT
    #----------------------------------------------------------------------
    func_mmmv_wait_and_sync_t1
    func_mmmv_assert_file_exists_t1 "$S_FP_CLONESCRIPT" \
        "470c0e54-2794-47d8-8160-8360902038e7"
    #----------------------------------------------------------------------
} # func_initialize_clonescript

#--------------------------------------------------------------------------

func_finalize_clonescript(){
    #----------------------------------------------------------------------
    func_mmmv_wait_and_sync_t1
    func_mmmv_assert_file_exists_t1 "$S_FP_CLONESCRIPT" \
        "10a03d6c-159c-40bd-9550-8360902038e7"
    echo "" >> $S_FP_CLONESCRIPT
    echo "wait ; sync ; wait ;" >> $S_FP_CLONESCRIPT
    echo "" >> $S_FP_CLONESCRIPT
    echo "#===========================================================================" >> $S_FP_CLONESCRIPT
...
func_main(){
    ...
    func_mmmv_assert_folder_exists_t1 "$S_FP_DIR" \
        "47745dd4-bf53-4217-8650-8360902038e7"
    cd $S_FP_DIR  # a way to partially test access
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "15b5a401-f2e3-4bf2-8a40-8360902038e7"
    #------------------------------
    func_mmmv_create_folder_t1 "$S_FP_CLONESCRIPT_PARENT_FOLDER"
    cd $S_FP_CLONESCRIPT_PARENT_FOLDER
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "8350c956-8b0a-44de-b140-8360902038e7"
    #------------------------------
    local S_TMP_0="`which mmmv_cre_temporary_file_t1 2> /dev/null`"
    if [ "$S_TMP_0" != "" ]; then
        func_mmmv_assert_file_exists_t1 "$S_TMP_0" \
            "12faa941-5fcc-4ab4-8240-8360902038e7"
        S_FP_URLLIST_TMP_0="`mmmv_cre_temporary_file_t1`"
        S_FP_URLLIST_TMP_1="`mmmv_cre_temporary_file_t1`"
    fi
    #------------------------------
    echo ""
    func_loop_01 "$SI_MAX_N_OF_JSON_PAGES"
    echo ""
    func_mmmv_assert_file_exists_t1 "$S_FP_URLLIST_TMP_1" \
        "2c244813-683b-4baf-8330-8360902038e7"
    #------------------------------
    func_initialize_clonescript
    $S_CMD_PREFIX_NICE cat $S_FP_URLLIST_TMP_1 | \
    $S_CMD_PREFIX_NICE sort | \
    $S_CMD_PREFIX_NICE uniq | \
    $S_CMD_PREFIX_NICE $S_CMD_GNU_SED -e '/^[[:blank:]]*$/d' | \
    $S_CMD_PREFIX_NICE $S_CMD_GNU_SED -e \
    's/^/func_clone /g' >> $S_FP_CLONESCRIPT
    #'s/^/nice -n 5 git clone --recursive /g' >> $S_FP_CLONESCRIPT
    func_finalize_clonescript
    rm -f "$S_FP_URLLIST_TMP_0"
    rm -f "$S_FP_URLLIST_TMP_1"
    #------------------------------
    func_mmmv_assert_file_exists_t1 "$S_FP_CLONESCRIPT" \
        "5fd1f0e5-d772-4343-b730-8360902038e7"
    chmod 0700 $S_FP_CLONESCRIPT
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "3370f337-53f4-4889-b420-8360902038e7"
    #------------------------------
    echo ""
    echo "The clonesript path:"
    echo ""
    echo -e "\e[92m    $S_FP_CLONESCRIPT \e[39m"
    echo ""
    echo "Thank You for trying out this script. "
    echo "GUID=='9d97583d-8807-4909-b12f-8360902038e7'"
    echo ""
    #------------------------------
} # func_main
func_main
...
exit 0
#==========================================================================
# S_VERSION_OF_THIS_FILE="cc825821-2edc-4170-b120-8360902038e7"
#==========================================================================
